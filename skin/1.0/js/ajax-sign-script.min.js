...
function chks(){
	...
	if(isPoneAvailable($('#phone').val()) == false){
		$("<label class='error'></label>").html("手机号格式错误").attr("id","phone-error").appendTo(".phone")
		state = false;
	}else{
		$(".phone .error").html("");
		state = true;
	...
	if(isRealname($('#realname').val()) == false){
		$("<label class='error'></label>").html("姓名格式错误").attr("id","realname-error").appendTo(".realname")
		state = false;
	}else{
		$(".realname .error").html("");
		state = true;
	...
	if(isIdcard($('#idcard').val()) == false){
		$("<label class='error'></label>").html("身份号格式错误").attr("id","idcard-error").appendTo(".idcard")
		state = false;
	}else{
		$(".idcard .error").html("");
		state = true;
